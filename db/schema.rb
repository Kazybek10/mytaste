...
ActiveRecord::Schema[7.1].define(version: 2026_04_15_110130) do
  ...
  create_table "user_items", force: :cascade do |t|
    ...
    t.index ["watch_list_id"], name: "index_user_items_on_watch_list_id"
  end
  ...
  add_foreign_key "user_items", "watch_lists"
